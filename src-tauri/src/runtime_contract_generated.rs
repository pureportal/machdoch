...
pub const DEFAULT_MODEL_BY_PROVIDER: [(&str, &str); 7] = [("openai", "gpt-5.5"), ("anthropic", "claude-sonnet-5"), ("google", "gemini-3.5-flash"), ("langdock", "gpt-5.5"), ("codex-cli", "gpt-5.5"), ("claude-cli", "sonnet"), ("copilot-cli", "auto")];
