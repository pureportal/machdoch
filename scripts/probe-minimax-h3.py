...
source = os.environ.get("FIZGIG_SOURCE")
if source:
...
def main():
    ...
    parser.add_argument("--swap-blocks", type=int, default=30)
    ...
    with torch.no_grad():
        video_latent, audio_latent = sample_image(
            ...
            cfg_scale=1.0, seed=57, dtype=torch.bfloat16, ref_latents=[reference_latent],
