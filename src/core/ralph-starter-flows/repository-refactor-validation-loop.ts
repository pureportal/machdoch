...
const autonomousRefactoringFlow: RalphFlow = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "INPUT",
      prompt: "Configure the repository refactor template before scanning.",
      ...
      fields: [
        {
          ...
          type: "path",
          defaultValue: ".",
          help: "Workspace-relative root scanned into deterministic JSON scopes.",
          variableName: "scopeRoot",
        },
        {
          id: "scopeSelectionStrategy",
          ...
          options: [
            ...
            { value: "least-validated", label: "Least validated" },
            { value: "priority", label: "Priority" },
            { value: "random-seeded", label: "Seeded random" },
          ],
          variableName: "scopeSelectionStrategy",
        },
        {
          id: "scopeRegistryFile",
          label: "Scope registry JSON",
          type: "path",
          defaultValue: ".machdoch/ralph/scope-registry/repository-refactor-validation-loop.scope-registry.json",
          variableName: "scopeRegistryFile",
        },
        {
          id: "scopeRegistryMarkdown",
          label: "Scope registry notes",
          type: "path",
          defaultValue: ".machdoch/ralph/scope-registry/repository-refactor-validation-loop.scope-registry.md",
          variableName: "scopeRegistryMarkdown",
        },
        {
          id: "refactorObjective",
          label: "Refactor objective",
          type: "textarea",
          defaultValue: "Improve maintainability while preserving behavior.",
          variableName: "refactorObjective",
        },
        {
          id: "fileNamingPolicy",
          label: "File naming policy",
          type: "textarea",
          defaultValue: "Follow existing framework and repository conventions.",
          variableName: "fileNamingPolicy",
        },
        {
          id: "maxFileLines",
          label: "Maximum file lines",
          type: "number",
          defaultValue: 500,
          validation: { min: 100, max: 5000, step: 50 },
          variableName: "maxFileLines",
        },
        {
          id: "helperPlacementPolicy",
          label: "Helper placement policy",
          type: "textarea",
          defaultValue: "Follow existing module-local and shared helper conventions.",
          variableName: "helperPlacementPolicy",
        },
        {
          id: "testFramework",
        ...
        },
        {
          ...
          help: "Leave blank to skip command execution. Blank commands never count as successful validation.",
          variableName: "validationCommand",
        },
        {
          id: "excludePaths",
          label: "Exclude paths",
          type: "textarea",
          defaultValue: "node_modules, dist, build, coverage, target, .next, .nuxt, .turbo, .cache, vendor, generated",
          variableName: "excludePaths",
        },
        {
          id: "allowPublicApiChanges",
          label: "Allow public API changes",
          type: "boolean",
          defaultValue: false,
          variableName: "allowPublicApiChanges",
        },
        {
          id: "notesFile",
          label: "Notes file",
          type: "path",
          defaultValue: "RALPH_REFACTOR_NOTES.md",
          variableName: "notesFile",
        },
        {
          id: "maxRefactorPasses",
          label: "Maximum refactor passes",
          type: "number",
          defaultValue: 5,
          validation: { min: 1, max: 25, step: 1 },
          variableName: "maxRefactorPasses",
        },
      ],
    },
    {
  ...
  edges: [
    ...
    { id: "configure-to-scan-scopes", from: "configure-template", fromOutput: "SUCCESS", to: "scan-scopes" },
