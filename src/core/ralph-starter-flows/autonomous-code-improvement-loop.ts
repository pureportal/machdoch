...
const autonomousCodeImprovementLoopFlow: RalphFlow = {
  ...
  variables: [
    ...
    },
    {
      ...
      type: "text",
      default:
        "Prefer high-confidence improvements to correctness, reliability, UX, accessibility, performance, error handling, tests, or maintainability. Behavior changes are allowed when they are intentional, bounded, documented, and verified.",
      required: false,
    },
    {
      ...
      type: "text",
      default:
        "Only continue when there is concrete code, test, runtime, UX, accessibility, performance, or security evidence that the improvement is worth making now. Stop instead of inventing speculative cleanup, premature abstraction, cosmetic churn, or tiny nits.",
      required: false,
    },
    {
      name: "riskTolerance",
    ...
    {
      name: "activeImprovementFile",
      type: "path",
      default: ".machdoch/ralph/code-improvements/active-improvement.json",
      required: false,
    },
    {
    ...
    },
    {
      name: "candidateFile",
      type: "path",
      default: "{{run:artifactRoot}}/code-improvements/candidate.json",
      required: false,
    },
    {
      name: "reviewFile",
  ...
  blocks: [
    ...
    },
    {
      ...
      utility: {
        ...
        condition: {
          style: "javascript",
          expression:
            "(() => { const output = context.resultsByBlock?.['choose-improvement']?.data?.output; const decision = output?.decision; if (!['IMPLEMENT', 'STOP', 'DEFER'].includes(decision)) throw new Error('Code improvement selection decision is missing or invalid.'); if (decision !== 'IMPLEMENT') return false; const selected = output?.selectedCandidate; if (!selected || typeof selected !== 'object' || Array.isArray(selected) || Object.keys(selected).length === 0) throw new Error('IMPLEMENT requires a structured selected candidate.'); return true; })()",
        },
      },
    },
    {
      ...
      utility: {
        ...
        condition: {
          style: "javascript",
          expression:
            "(() => { const decision = context.resultsByBlock?.['choose-improvement']?.data?.output?.decision; if (!['IMPLEMENT', 'STOP', 'DEFER'].includes(decision)) throw new Error('Code improvement selection decision is missing or invalid.'); return decision === 'DEFER'; })()",
        },
      },
    },
    {
      ...
      utility: {
        ...
        schema: {
          ...
          required: [
            ...
            "summary",
            "findings",
            "behaviorChangeAssessment",
            "securityRegressionAssessment",
    ...
    },
    {
      ...
      utility: {
        ...
        input:
          '{"outcome":"DONE","scopeId":"{{data:select-scope:scope.id}}","candidateId":"{{data:choose-improvement:output.selectedCandidate.id}}"}',
      },
    },
    {
    ...
    },
    {
      ...
      utility: {
        ...
        path: "{{improvementOutcomesFile:path=.machdoch/ralph/code-improvements/outcomes.jsonl}}",
        input:
          '{"outcome":"STOP","scopeRoot":"{{scopeRoot:path=.}}","reason":"No evidence-backed package cleared the threshold."}',
      },
    },
    {
  ...
  edges: [
    ...
    },
    {
      ...
      from: "read-completed-improvements",
      fromOutput: "SUCCESS",
    ...
    },
    {
      ...
      from: "choose-improvement",
      fromOutput: "SUCCESS",
      to: "has-actionable-improvement",
    },
    {
      id: "choose-invalid",
      from: "choose-improvement",
    ...
    {
      id: "active-improvement-exists",
      from: "find-active-improvement",
      fromOutput: "EXISTS",
      to: "archive-superseded-improvement",
    },
    {
      id: "active-improvement-missing",
      from: "find-active-improvement",
      fromOutput: "MISSING",
      to: "write-active-improvement",
    },
    {
      id: "active-improvement-check-error",
      from: "find-active-improvement",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    {
      id: "superseded-archive-to-write",
      from: "archive-superseded-improvement",
      fromOutput: "SUCCESS",
      to: "write-active-improvement",
    },
    {
      id: "superseded-archive-missing-to-write",
      from: "archive-superseded-improvement",
      fromOutput: "NOT_FOUND",
      to: "write-active-improvement",
    },
    {
      id: "superseded-archive-error",
      from: "archive-superseded-improvement",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    ...
    {
      id: "count-improvement-pass-continue",
      from: "count-improvement-pass",
      fromOutput: "CONTINUE",
      to: "implement-improvement",
    },
    {
      id: "count-improvement-pass-limit",
      from: "count-improvement-pass",
      fromOutput: "LIMIT_REACHED",
      to: "defer-scope",
    },
    {
      id: "count-improvement-pass-error",
      from: "count-improvement-pass",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    ...
    {
      id: "verification-success-to-visual",
    ...
    {
      id: "no-useful-work-to-defer",
      from: "useful-work-produced",
      fromOutput: "NO_MATCH",
      to: "defer-scope",
    },
    {
      id: "useful-work-error-to-defer",
      from: "useful-work-produced",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    ...
    },
    {
      ...
      from: "review-tier-decision",
      fromOutput: "NO_MATCH",
      to: "count-final-validation-scan",
    },
    {
    ...
    {
      id: "final-scan-counter-continue",
      from: "count-final-validation-scan",
      fromOutput: "CONTINUE",
      to: "validate-improvement",
    },
    {
      id: "final-scan-counter-limit",
      from: "count-final-validation-scan",
      fromOutput: "LIMIT_REACHED",
      to: "defer-scope",
    },
    {
      id: "final-scan-counter-error",
      from: "count-final-validation-scan",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    ...
    },
    {
      ...
      from: "read-active-improvement",
      fromOutput: "SUCCESS",
      to: "append-completed-improvement",
    },
    {
    ...
    },
    {
      ...
      from: "append-completed-improvement",
      fromOutput: "SUCCESS",
...
export const autonomousCodeImprovementLoopStarterFlow = {
  ...
  protocol: {
    schemaVersion: 1,
    verification: {
      planId: "starter-autonomous-code-improvement-loop:frozen-verification",
