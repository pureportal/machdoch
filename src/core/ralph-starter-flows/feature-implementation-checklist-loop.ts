...
const fullFeatureImplementationFlow: RalphFlow = {
  ...
  variables: [
    ...
    },
    {
      ...
      type: "text",
      default:
        "Autonomously identify and implement the highest-value bounded feature supported by repository evidence.",
      required: false,
    },
    ...
    },
    {
      ...
      type: "path",
      default:
        "{{run:artifactRoot}}/feature-implementation/project-commands.json",
      required: false,
    },
    {
      name: "gitSnapshotFile",
      type: "path",
      default: "{{run:artifactRoot}}/feature-implementation/git-snapshot.json",
      required: false,
    },
    {
      name: "gitDiffFile",
      type: "path",
      default: "{{run:artifactRoot}}/feature-implementation/git-diff.json",
      required: false,
    },
    {
      name: "featureReportFile",
      type: "path",
      default: "{{run:artifactRoot}}/feature-implementation/final-report.json",
      required: false,
    },
    {
      name: "featureReportMarkdown",
      type: "path",
      default: "{{run:artifactRoot}}/feature-implementation/final-report.md",
      required: false,
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      utility: {
        type: "PROMPT_JSON",
        outputPath: "{{data:resolve-checklist-path:output.path}}",
        maxAttempts: 2,
        schema: {
          type: "object",
          additionalProperties: false,
    ...
    {
      id: "assess-checklist-tasks",
      title: "Assess Checklist Tasks",
      position: { x: 2550, y: 0 },
      size: { width: 280, height: 170 },
      type: "UTILITY",
      utility: {
    ...
    },
    {
      ...
      utility: {
        type: "LOOP_COUNTER",
        counterName:
          "feature-implementation-checklist-loop.implementation-pass.{{data:resolve-checklist-path:output.featureId}}.{{data:select-next-task:tasks.0.id}}.{{data:select-next-task:indexes.0}}",
    ...
    {
      id: "record-blocked-outcome",
      title: "Record Blocked Feature Outcome",
      position: { x: 4700, y: 620 },
      size: { width: 280, height: 170 },
      settings: { retry: { mode: "finite", maxRetries: 3, delaySeconds: 1 } },
      type: "UTILITY",
      utility: {
  ...
  edges: [
    ...
    {
      id: "detect-commands-to-resolve-checklist",
      from: "detect-project-commands",
      fromOutput: "SUCCESS",
      to: "resolve-checklist-path",
    },
    {
      id: "detect-commands-empty-to-resolve-checklist",
      from: "detect-project-commands",
      fromOutput: "EMPTY",
      to: "resolve-checklist-path",
    },
    {
      id: "detect-commands-error-to-resolve-checklist",
      from: "detect-project-commands",
      fromOutput: "ERROR",
      to: "resolve-checklist-path",
    },
    {
      id: "resolve-checklist-to-exists",
      from: "resolve-checklist-path",
      fromOutput: "SUCCESS",
      to: "checklist-exists",
    },
    {
      id: "resolve-checklist-error",
      from: "resolve-checklist-path",
      fromOutput: "ERROR",
      to: "record-invalid-outcome",
    },
    {
      id: "checklist-exists-read",
      from: "checklist-exists",
      fromOutput: "EXISTS",
      to: "read-checklist",
    },
    {
      id: "checklist-missing-to-brief",
      from: "checklist-exists",
      fromOutput: "MISSING",
      to: "prepare-feature-brief",
    },
    {
      id: "checklist-exists-error-to-brief",
      from: "checklist-exists",
      fromOutput: "ERROR",
      to: "prepare-feature-brief",
    },
    {
      id: "read-checklist-to-match",
      from: "read-checklist",
      fromOutput: "SUCCESS",
      to: "checklist-matches-feature",
    },
    {
      id: "read-checklist-invalid-to-archive",
      from: "read-checklist",
      fromOutput: "INVALID",
      to: "archive-mismatched-checklist",
    },
    {
      id: "read-checklist-error-to-brief",
      from: "read-checklist",
      fromOutput: "ERROR",
      to: "prepare-feature-brief",
    },
    {
      id: "read-checklist-not-found-to-brief",
      from: "read-checklist",
      fromOutput: "NOT_FOUND",
      to: "prepare-feature-brief",
    },
    {
      id: "matching-checklist-to-assessment",
      from: "checklist-matches-feature",
      fromOutput: "MATCH",
      to: "assess-checklist-tasks",
    },
    {
      id: "mismatched-checklist-to-archive",
      from: "checklist-matches-feature",
      fromOutput: "NO_MATCH",
      to: "archive-mismatched-checklist",
    },
    {
      id: "checklist-match-error-to-archive",
      from: "checklist-matches-feature",
      fromOutput: "ERROR",
      to: "archive-mismatched-checklist",
    },
    {
      id: "archive-mismatch-to-brief",
      from: "archive-mismatched-checklist",
      fromOutput: "SUCCESS",
      to: "prepare-feature-brief",
    },
    {
      id: "archive-mismatch-missing-to-brief",
      from: "archive-mismatched-checklist",
      fromOutput: "NOT_FOUND",
      to: "prepare-feature-brief",
    },
    {
      id: "archive-mismatch-error-to-invalid",
      from: "archive-mismatched-checklist",
      fromOutput: "ERROR",
      to: "record-invalid-outcome",
    },
    {
      id: "brief-to-research-decision",
      from: "prepare-feature-brief",
      fromOutput: "SUCCESS",
    ...
    {
      id: "research-to-specification",
      from: "initial-research",
      fromOutput: "SUCCESS",
      to: "specification-checklist",
    },
    {
      id: "research-error-to-specification",
      from: "initial-research",
      fromOutput: "ERROR",
      to: "specification-checklist",
    },
    {
      id: "specification-to-assessment",
      from: "specification-checklist",
      fromOutput: "SUCCESS",
      to: "assess-checklist-tasks",
    },
    {
      id: "specification-invalid",
      from: "specification-checklist",
      fromOutput: "INVALID",
      to: "record-invalid-outcome",
    },
    ...
    {
      id: "assessed-checklist-ready-to-select",
    ...
    {
      id: "assessed-checklist-missing-to-invalid",
      from: "assess-checklist-tasks",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-outcome",
    },
    {
      id: "assessed-checklist-invalid",
      from: "assess-checklist-tasks",
      fromOutput: "INVALID",
      to: "record-invalid-outcome",
    },
    {
      id: "assessed-checklist-error-to-defer",
      from: "assess-checklist-tasks",
      fromOutput: "ERROR",
    ...
    {
      id: "checks-success-to-visual-decision",
      from: "run-configured-checks",
      fromOutput: "SUCCESS",
      to: "visual-decision",
    },
    {
      id: "checks-failed-to-visual-decision",
      from: "run-configured-checks",
      fromOutput: "FAILED",
      to: "visual-decision",
    },
    {
      id: "checks-error-to-visual-decision",
      from: "run-configured-checks",
      fromOutput: "ERROR",
      to: "visual-decision",
    },
    ...
    {
      id: "mark-deferred-invalid-to-record",
      from: "mark-tasks-deferred",
      fromOutput: "INVALID",
      to: "record-invalid-outcome",
    },
    {
      id: "mark-deferred-error-to-record",
      from: "mark-tasks-deferred",
      fromOutput: "ERROR",
      to: "record-invalid-outcome",
    },
    {
      id: "record-done-to-report",
      from: "record-done-outcome",
      fromOutput: "SUCCESS",
      to: "final-report",
    },
    {
      id: "record-done-invalid-to-retained-report",
      from: "record-done-outcome",
      fromOutput: "INVALID",
      to: "retained-checklist-report",
    },
    {
      id: "record-done-error-to-retained-report",
      from: "record-done-outcome",
      fromOutput: "ERROR",
      to: "retained-checklist-report",
    },
    {
      id: "record-deferred-to-retained-report",
      from: "record-deferred-outcome",
      fromOutput: "SUCCESS",
      to: "retained-checklist-report",
    },
    {
      id: "record-deferred-invalid-to-retained-report",
      from: "record-deferred-outcome",
      fromOutput: "INVALID",
      to: "retained-checklist-report",
    },
    {
      id: "record-deferred-error-to-retained-report",
      from: "record-deferred-outcome",
      fromOutput: "ERROR",
      to: "retained-checklist-report",
    },
    {
      id: "record-blocked-to-retained-report",
      from: "record-blocked-outcome",
      fromOutput: "SUCCESS",
      to: "retained-checklist-report",
    },
    {
      id: "record-blocked-invalid-to-retained-report",
      from: "record-blocked-outcome",
      fromOutput: "INVALID",
      to: "retained-checklist-report",
    },
    {
      id: "record-blocked-error-to-retained-report",
      from: "record-blocked-outcome",
      fromOutput: "ERROR",
      to: "retained-checklist-report",
    },
    ...
    {
      id: "record-invalid-error-to-retained-report",
      from: "record-invalid-outcome",
      fromOutput: "ERROR",
      to: "retained-checklist-report",
    },
    {
      id: "report-success-to-ledger-gate",
      from: "final-report",
      fromOutput: "SUCCESS",
    ...
    },
    {
      ...
      from: "retained-checklist-report",
      fromOutput: "SUCCESS",
      to: "record-autonomy-deferral",
    },
    {
      id: "retained-report-error-to-deferral",
      from: "retained-checklist-report",
      fromOutput: "ERROR",
      to: "record-autonomy-deferral",
    },
    {
      id: "ledger-persisted-to-archive",
      from: "outcome-ledger-persisted",
      fromOutput: "MATCH",
      to: "archive-feature-checklist",
    },
    {
      id: "ledger-failed-retain-state",
      from: "outcome-ledger-persisted",
      fromOutput: "NO_MATCH",
      to: "record-autonomy-deferral",
    },
    {
      id: "ledger-gate-error-retain-state",
      from: "outcome-ledger-persisted",
      fromOutput: "ERROR",
      to: "record-autonomy-deferral",
    },
    {
      id: "archive-feature-to-outcome",
      from: "archive-feature-checklist",
      fromOutput: "SUCCESS",
      to: "feature-outcome-is-done",
    },
    {
      id: "archive-feature-missing-to-outcome",
      from: "archive-feature-checklist",
      fromOutput: "NOT_FOUND",
      to: "feature-outcome-is-done",
    },
    {
      id: "archive-feature-error-to-deferral",
      from: "archive-feature-checklist",
      fromOutput: "ERROR",
      to: "record-autonomy-deferral",
    },
    {
      id: "feature-done-to-complete",
      from: "feature-outcome-is-done",
      fromOutput: "MATCH",
      to: "complete",
    },
    {
      id: "feature-not-done-to-notify",
      from: "feature-outcome-is-done",
      fromOutput: "NO_MATCH",
      to: "record-autonomy-deferral",
    },
    {
      id: "feature-outcome-error-to-notify",
      from: "feature-outcome-is-done",
      fromOutput: "ERROR",
      to: "record-autonomy-deferral",
    },
    {
      id: "record-autonomy-deferral-to-deferred",
      from: "record-autonomy-deferral",
      fromOutput: "SUCCESS",
      to: "deferred",
    },
  ],
