...
const fullFeatureImplementationFlow: RalphFlow = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "INPUT",
      prompt: "Configure the feature implementation template before Ralph starts.",
      submitLabel: "Start implementation loop",
      fields: [
        {
          id: "featureId",
          label: "Feature id",
          type: "text",
          defaultValue: "current-feature",
          help: "Stable id used for the JSON checklist artifact.",
        ...
        },
        {
          ...
          type: "textarea",
          required: true,
          placeholder: "Describe the feature or change to implement.",
        ...
        },
        {
          ...
          type: "textarea",
          required: false,
          placeholder: "Observable outcomes, edge cases, or done criteria.",
        ...
        },
        {
          ...
          type: "path",
          defaultValue: ".machdoch/feature-implementation/current-feature.checklist.json",
          variableName: "checklistFile",
        },
        {
          id: "checklistDirectory",
          label: "Checklist directory",
          type: "path",
          defaultValue: ".machdoch/feature-implementation",
          variableName: "checklistDirectory",
        },
        { id: "enableOnlineResearch", label: "Use online research", type: "boolean", defaultValue: false, variableName: "enableOnlineResearch" },
        { id: "enableInterview", label: "Interview before implementation", type: "boolean", defaultValue: true, variableName: "enableInterview" },
        { id: "enableVisualReview", label: "Run visual review", type: "boolean", defaultValue: false, variableName: "enableVisualReview" },
        { id: "targetUrl", label: "Target URL", type: "url", required: false, placeholder: "https://app.example.com/path", variableName: "targetUrl" },
        { id: "healthUrl", label: "Health URL", type: "url", required: false, placeholder: "https://app.example.com/health", variableName: "healthUrl" },
        { id: "screenshotPath", label: "Screenshot path", type: "path", required: false, variableName: "screenshotPath" },
        {
          ...
          help: "Leave blank to skip command execution. Blank commands never count as successful verification.",
          variableName: "verificationCommand",
        },
        {
          id: "authInstructions",
          ...
          type: "textarea",
          required: false,
          placeholder: "Seed users, test credentials, or protected route notes.",
          variableName: "authInstructions",
        },
        {
          id: "designGuidelines",
          ...
          type: "textarea",
          required: false,
          placeholder: "UI conventions, layout expectations, or design-system rules.",
          variableName: "designGuidelines",
        },
        {
          ...
          variableName: "implementationScope",
        },
        {
          id: "maxImplementationPasses",
          label: "Maximum implementation passes",
          type: "number",
          defaultValue: 8,
          validation: { min: 1, max: 50, step: 1 },
          variableName: "maxImplementationPasses",
        },
      ],
    },
    {
  ...
  edges: [
    { id: "start-to-configure", from: "start", fromOutput: "SUCCESS", to: "configure-template" },
    { id: "configure-to-detect-commands", from: "configure-template", fromOutput: "SUCCESS", to: "detect-project-commands" },
    { id: "configure-cancelled", from: "configure-template", fromOutput: "CANCELLED", to: "blocked" },
    { id: "configure-timeout", from: "configure-template", fromOutput: "TIMEOUT", to: "blocked" },
    { id: "configure-error", from: "configure-template", fromOutput: "ERROR", to: "blocked" },
