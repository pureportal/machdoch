...
const securityFixLoopFlow: RalphFlow = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "INPUT",
      prompt:
        "Configure this security template before Ralph starts reviewing and fixing issues.",
      submitLabel: "Start security loop",
      fields: [
        {
          id: "scopeRoot",
          label: "Scope root",
        ...
        },
        {
          ...
          type: "path",
          defaultValue: ".machdoch/ralph/scope-registry/security-review-fix-loop.scope-registry.json",
        ...
        },
        {
          ...
          type: "path",
          defaultValue: ".machdoch/ralph/scope-registry/security-review-fix-loop.scope-registry.md",
        ...
        },
        {
          ...
          help: "Examples: auto-detect, Next.js + NestJS + PostgreSQL, Rust CLI, Python service.",
          variableName: "projectStack",
        },
        {
          id: "securityStandards",
          label: "Security standards",
          type: "textarea",
          defaultValue: "OWASP Top 10, OWASP ASVS",
          variableName: "securityStandards",
        },
        {
          ...
          variableName: "severityThreshold",
        },
        {
          id: "enableOnlineResearch",
          label: "Use online research",
          type: "boolean",
          defaultValue: true,
          variableName: "enableOnlineResearch",
        },
        {
          id: "verificationCommand",
          label: "Verification command",
          type: "text",
          placeholder: "pnpm test && pnpm lint",
        ...
        {
          id: "authTestInstructions",
          label: "Auth test instructions",
          type: "textarea",
          required: false,
          placeholder: "Seed users, test credentials, protected routes, or manual constraints.",
          variableName: "authTestInstructions",
        },
        {
          id: "historyFile",
          label: "History file",
          type: "path",
          defaultValue: "RALPH_SECURITY_HISTORY.md",
        ...
        },
        {
          ...
          variableName: "schemaChangePolicy",
        },
        {
          id: "allowDependencyChanges",
          label: "Allow dependency changes",
          type: "boolean",
          defaultValue: false,
          variableName: "allowDependencyChanges",
        },
        {
          id: "maxFixLoops",
          label: "Maximum fix loops",
          type: "number",
          defaultValue: 10,
          validation: { min: 1, max: 50, step: 1 },
          variableName: "maxFixLoops",
        },
      ],
    },
    {
  ...
  edges: [
    ...
    { id: "configure-to-research-decision", from: "configure-template", fromOutput: "SUCCESS", to: "research-decision" },
