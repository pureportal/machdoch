...
export const MEDIA_NODE_DEFINITIONS = [
  ...
  },
  {
    ...
    summary:
      "Animates immutable endpoints with hardware-adaptive LTX-Video keyframe conditioning, temporal matting, and explicit loop or shot assembly.",
    layer: "task",
    category: "Generation",
    paletteVisibility: "default",
    maxInstances: 1,
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Resolution",
        description:
          "Native video resolution. Higher profiles improve faces and costume detail but increase denoising time.",
        group: "Creative",
        kind: "select",
        required: true,
      ...
      },
      {
        ...
        description:
          "The current local video adapter leaves audio for a later composition stage.",
        group: "Creative",
        kind: "boolean",
        required: true,
        defaultValue: false,
      ...
      },
      {
        ...
        label: "Exact model pin",
        description:
          "Prefers FramePack 13B with native start/end anti-drift conditioning; execution falls back to LTX 2B on CPU or lower-VRAM hardware.",
        group: "Expert",
        kind: "model",
        required: true,
        defaultValue: "local:framepack-i2v-hy-13b",
        examples: [
      ...
      },
      {
        ...
        label: "Source frames",
        description:
          "Thirty-three frames form one complete FramePack anti-drift window; lightweight LTX uses the compatible 8k+1 counts.",
        group: "Expert",
        kind: "number",
        required: true,
        defaultValue: 33,
        examples: [17, 33, 65, 129],
        min: 9,
        max: 257,
        step: 8,
        integer: true,
      },
      {
        ...
        description:
          "FramePack uses 30 quality steps; the distilled lightweight LTX trajectory resolves to eight.",
        group: "Expert",
        kind: "number",
        required: true,
        defaultValue: 30,
      ...
      },
      {
        ...
        description:
          "FramePack uses guidance 9 for prompt adherence; distilled LTX resolves to guidance 1.",
        group: "Creative",
        kind: "number",
        required: true,
        defaultValue: 9,
      ...
      },
      {
        ...
        label: "Adaptive memory profile",
        description:
          "Keeps older saved WAN flows readable while current models select an offload policy from the available hardware.",
        group: "Expert",
        kind: "boolean",
        required: true,
        defaultValue: true,
    ...
    privacyEffects: [
      "Prompt text and every explicitly connected keyframe remain on this device.",
      "The local adapter uses native first/last keyframe conditioning and records the effective model.",
    ],
    costEffects: [
