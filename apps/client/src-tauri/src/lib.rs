...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            media::media_install_pose_control,
            ...
            media::media_inspect_krea_training_images,
            media::media_submit_krea_training,
            media::media_get_krea_training_status,
            media::media_cancel_krea_training,
            media::media_resume_krea_training,
            media::media_finish_krea_training,
            media::media_inspect_civitai_model_addon,
            media::civitai_commands::media_search_civitai,
            ...
            media::civitai_commands::media_cancel_civitai_download,
            media::media_import_model_addon,
            media::media_update_model_resource,
            ...
            media::workflow::media_execute_workflow,
            media::workflow_models::media_install_workflow_model,
            ...
            runtime_snapshot::get_workspace_reasoning_bank_lessons,
            ...
            runtime_snapshot::save_user_workspace_memory_default_enabled,
            ...
            runtime_snapshot::save_user_speech_to_text_key_terms,
            runtime_snapshot::save_user_speech_to_text_context,
