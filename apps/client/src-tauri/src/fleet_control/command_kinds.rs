...
fn requires_flow_id(kind: &str) -> bool {
    includes_command(FLOW_ID_COMMANDS, kind)
}
...
mod tests {
    ...
    #[test]
    fn supported_command_groups_cover_fleet_command_targets() {
    ...
    #[test]
    fn supported_reasoning_modes_match_fleet_command_validation() {
