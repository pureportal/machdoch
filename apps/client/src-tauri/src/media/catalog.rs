...
const LOCAL_PROVIDER_GENERATION_CAPABILITIES: &[&str] = &[
    "text-to-image",
    "image-to-image",
    "masked-image-edit",
...
const PROVIDERS: &[BuiltinProvider] = &[
    ...
    BuiltinProvider {
        ...
        target: "local",
        lifecycle: "active",
        capabilities: LOCAL_PROVIDER_GENERATION_CAPABILITIES,
...
const MODELS: &[BuiltinModel] = &[
    ...
    BuiltinModel {
        ...
        expected_download_gb: Some(15.46),
        cost_hint: None,
        privacy_summary: "Prompts and references remain on this device.",
        limitation: Some("Requires a GPU with bfloat16 support."),
        stale_after_seconds: MONTH_SECONDS,
        source_url: Some("https://huggingface.co/gitcat404/IntroSVG-Qwen2.5-VL-7B"),
    },
    BuiltinModel {
    ...
    BuiltinModel {
        ...
        license_name: "Apache License 2.0",
        license_spdx_id: Some("Apache-2.0"),
        license_source_url: "https://huggingface.co/Wan-AI/Wan2.2-TI2V-5B-Diffusers",
        license_commercial_use: "allowed",
        license_requires_acceptance: false,
        recommended: true,
        speed_score: 45,
        ...
        expected_download_gb: Some(31.85),
        cost_hint: None,
        privacy_summary: "Prompts and source frames remain on this device.",
        limitation: Some("Requires a bfloat16 GPU. The 16 GB preview uses the experimental low-memory profile."),
        stale_after_seconds: 10 * 365 * 24 * 60 * 60,
        source_url: Some("https://huggingface.co/Wan-AI/Wan2.2-TI2V-5B-Diffusers"),
    },
    BuiltinModel {
