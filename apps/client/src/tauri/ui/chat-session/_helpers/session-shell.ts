...
export const SETTINGS_SECTIONS: ReadonlyArray<{
  ...
  },
  {
    ...
    label: "Web search",
    group: "Capabilities",
    description: "Search provider and credentials.",
  ...
  },
  {
    ...
    label: "Voice",
    group: "Capabilities",
    description: "Speech, replies, and audio devices.",
  ...
  },
  {
    ...
    group: "Data",
    description: "Send or receive global settings.",
...
export const SESSION_STATUS_META = {
  ...
  blocked: {
    ...
    filterLabel: "Blocked",
    icon: Ban,
    containerClassName: "border-amber-500/20 bg-amber-500/10",
    iconClassName: "text-amber-300",
  },
  cancelled: {
    label: "Cancelled",
    ...
    icon: CircleStop,
    containerClassName: "border-slate-700 bg-slate-900/80",
    iconClassName: "text-slate-400",
  },
  "timed-out": {
    label: "Timed out",
    filterLabel: "Timed out",
    icon: ClockAlert,
    containerClassName: "border-orange-500/20 bg-orange-500/10",
  ...
  unsupported: {
    ...
    icon: CircleSlash,
    containerClassName: "border-violet-500/20 bg-violet-500/10",
    iconClassName: "text-violet-300",
  },
  crashed: {
    label: "Crashed",
...
export const SESSION_STATUS_FILTERS = [
  ...
  {
    id: "blocked",
    label: SESSION_STATUS_META.blocked.filterLabel,
    icon: SESSION_STATUS_META.blocked.icon,
  },
  {
    id: "cancelled",
    label: SESSION_STATUS_META.cancelled.filterLabel,
    icon: SESSION_STATUS_META.cancelled.icon,
  },
  {
    id: "timed-out",
    label: SESSION_STATUS_META["timed-out"].filterLabel,
    icon: SESSION_STATUS_META["timed-out"].icon,
  },
  {
    id: "unsupported",
    label: SESSION_STATUS_META.unsupported.filterLabel,
    icon: SESSION_STATUS_META.unsupported.icon,
  },
  {
    id: "crashed",
