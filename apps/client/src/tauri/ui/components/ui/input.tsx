  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-oklch(0.705 0.015 286.067) focus-visible:ring-[1px] focus-visible:ring-oklch(0.705 0.015 286.067)/35 dark:focus-visible:border-oklch(0.552 0.016 285.938) dark:focus-visible:ring-oklch(0.552 0.016 285.938)/35",
