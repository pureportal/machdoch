  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Mask",
        description:
          "Limits the requested edit to a painted area of the base image.",
        group: "Creative",
        kind: "mask",
        required: false,
        defaultValue: null,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Memory profile",
        description:
          "Auto selects quality-preserving CPU block offload from host and adapter capacity, and records the resolved strategy.",
        group: "Expert",
        kind: "select",
        required: true,
        defaultValue: "auto",
    ...
    fields: [
      {
        ...
        description:
          "Local video output stores straight alpha; this explicit contract prevents accidental double premultiplication.",
        group: "Expert",
        kind: "select",
        required: true,
...
const validateFieldValue = (
  ...
  switch (field.kind) {
    ...
    case "asset":
      ...
      break;
    case "mask":
      isValid = value === null || isMediaImageMask(value);
      break;
    case "number":
      isValid =
        typeof value === "number" &&
