...
const autonomousFeatureGenerationLoopFlow: RalphFlow = {
  ...
  variables: [
    ...
    },
    {
      ...
      type: "path",
      default: "{{run:artifactRoot}}/autonomous-features/project-commands.json",
      required: false,
    },
    {
      name: "gitSnapshotFile",
      type: "path",
      default: "{{run:artifactRoot}}/autonomous-features/git-snapshot.json",
      required: false,
    },
    {
      name: "gitDiffFile",
      type: "path",
      default: "{{run:artifactRoot}}/autonomous-features/git-diff.json",
      required: false,
    },
    {
      name: "autonomousReportFile",
      type: "path",
      default: "{{run:artifactRoot}}/autonomous-features/final-report.json",
      required: false,
    },
    {
      name: "autonomousReportMarkdown",
      type: "path",
      default: "{{run:artifactRoot}}/autonomous-features/final-report.md",
      required: false,
    },
  ...
  blocks: [
    ...
    {
      id: "assess-goal-tasks",
      title: "Assess Active Goal Tasks",
    ...
    },
    {
      ...
      utility: {
        type: "LOOP_COUNTER",
        counterName:
          "autonomous-feature-generation-loop.implementation-pass.{{data:read-canonical-active-goal:json.id}}.{{data:select-next-task:tasks.0.id}}.{{data:select-next-task:indexes.0}}",
    ...
    {
      id: "record-blocked-goal-outcome",
      title: "Record Blocked Goal Outcome",
      position: { x: 5320, y: 760 },
      size: { width: 280, height: 160 },
      settings: { retry: { mode: "finite", maxRetries: 3, delaySeconds: 1 } },
      type: "UTILITY",
      utility: {
  ...
  edges: [
    ...
    {
      id: "detect-commands-to-find",
      from: "detect-project-commands",
      fromOutput: "SUCCESS",
      to: "find-active-goal",
    },
    {
      id: "detect-commands-empty-to-find",
      from: "detect-project-commands",
      fromOutput: "EMPTY",
      to: "find-active-goal",
    },
    {
      id: "detect-commands-error-to-find",
      from: "detect-project-commands",
      fromOutput: "ERROR",
      to: "find-active-goal",
    },
    {
      id: "active-goal-found",
      from: "find-active-goal",
      fromOutput: "EXISTS",
      to: "read-active-goal",
    },
    {
      id: "active-goal-empty",
      from: "find-active-goal",
      fromOutput: "MISSING",
      to: "read-completed-goals",
    },
    {
      id: "active-goal-search-error",
      from: "find-active-goal",
      fromOutput: "ERROR",
      to: "read-completed-goals",
    },
    {
      id: "read-active-goal-success",
      from: "read-active-goal",
      fromOutput: "SUCCESS",
      to: "prepare-active-goal",
    },
    {
      id: "read-active-goal-invalid",
      from: "read-active-goal",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "read-active-goal-not-found",
      from: "read-active-goal",
      fromOutput: "NOT_FOUND",
      to: "read-completed-goals",
    },
    {
      id: "read-active-goal-error",
      from: "read-active-goal",
      fromOutput: "ERROR",
      to: "read-completed-goals",
    },
    {
      id: "prepare-active-goal-success",
    ...
    {
      id: "understand-to-portfolio",
      from: "understand-project",
      fromOutput: "SUCCESS",
      to: "draft-feature-goal",
    },
    {
    ...
    {
      id: "portfolio-to-research-decision",
      from: "draft-feature-goal",
      fromOutput: "SUCCESS",
    ...
    },
    {
      ...
      fromOutput: "MATCH",
      to: "research-inspiration",
    },
    {
      id: "research-decision-skip",
      from: "research-decision",
      fromOutput: "NO_MATCH",
      to: "improve-feature-goal",
    },
    {
    ...
    {
      id: "research-to-improve",
      from: "research-inspiration",
      fromOutput: "SUCCESS",
      to: "improve-feature-goal",
    },
    {
      id: "research-error-to-improve",
      from: "research-inspiration",
      fromOutput: "ERROR",
      to: "improve-feature-goal",
    },
    {
      id: "improve-to-actionable-goal",
    ...
    {
      id: "actionable-goal-to-write",
      from: "has-actionable-goal",
      fromOutput: "MATCH",
      to: "write-active-goal",
    },
    {
      id: "no-actionable-goal",
      from: "has-actionable-goal",
      fromOutput: "NO_MATCH",
      to: "selection-is-deferred",
    },
    {
      id: "actionable-goal-error",
      from: "has-actionable-goal",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    ...
    },
    {
      ...
      from: "selection-is-deferred",
      fromOutput: "NO_MATCH",
      to: "record-no-action-goal-outcome",
    },
    {
      id: "selection-status-error-to-invalid",
      from: "selection-is-deferred",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    ...
    {
      id: "plan-to-read-canonical-goal",
    ...
    },
    {
      ...
      from: "read-canonical-active-goal",
      fromOutput: "SUCCESS",
      to: "assess-goal-tasks",
    },
    {
      id: "canonical-goal-invalid",
      from: "read-canonical-active-goal",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "canonical-goal-missing",
      from: "read-canonical-active-goal",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "canonical-goal-error",
      from: "read-canonical-active-goal",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "assessed-goal-ready-to-select",
      from: "assess-goal-tasks",
      fromOutput: "READY",
      to: "select-next-task",
    },
    {
      id: "assessed-goal-complete-to-read",
      from: "assess-goal-tasks",
      fromOutput: "COMPLETE",
      to: "read-completed-goal",
    },
    {
      id: "assessed-goal-blocked-to-ledger",
      from: "assess-goal-tasks",
      fromOutput: "BLOCKED",
    ...
    {
      id: "assessed-goal-missing-to-invalid",
      from: "assess-goal-tasks",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "assessed-goal-invalid",
      from: "assess-goal-tasks",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "assessed-goal-error-to-defer",
      from: "assess-goal-tasks",
      fromOutput: "ERROR",
      to: "record-deferred-goal-outcome",
    },
    {
      id: "select-task-to-snapshot",
      from: "select-next-task",
      fromOutput: "SELECTED",
      to: "git-snapshot-before",
    },
    {
      id: "select-task-empty-to-reassessment",
      from: "select-next-task",
      fromOutput: "EMPTY",
      to: "assess-goal-tasks",
    },
    ...
    {
      id: "select-task-invalid",
      from: "select-next-task",
      fromOutput: "INVALID",
      to: "assess-goal-tasks",
    },
    {
      id: "select-task-error",
      from: "select-next-task",
      fromOutput: "ERROR",
      to: "record-deferred-goal-outcome",
    },
    ...
    {
      id: "count-implementation-pass-error",
      from: "count-implementation-pass",
      fromOutput: "ERROR",
      to: "mark-tasks-deferred",
    },
    {
      id: "implementation-to-mark-verifying",
    ...
    {
      id: "mark-verifying-to-diff",
      from: "mark-tasks-verifying",
      fromOutput: "SUCCESS",
      to: "git-diff-summary",
    },
    {
      id: "mark-verifying-missing",
      from: "mark-tasks-verifying",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-verifying-invalid",
      from: "mark-tasks-verifying",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-verifying-error",
      from: "mark-tasks-verifying",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "git-diff-success-to-work-yield",
      from: "git-diff-summary",
      fromOutput: "SUCCESS",
      to: "work-yield-analysis",
    },
    {
      id: "git-diff-empty-to-work-yield",
      from: "git-diff-summary",
      fromOutput: "EMPTY",
      to: "work-yield-analysis",
    },
    {
      id: "git-diff-error-to-work-yield",
      from: "git-diff-summary",
      fromOutput: "ERROR",
      to: "work-yield-analysis",
    },
    ...
    {
      id: "verification-success-to-visual-decision",
      from: "run-verification",
      fromOutput: "SUCCESS",
      to: "visual-decision",
    },
    {
      id: "verification-failed-to-visual-decision",
      from: "run-verification",
      fromOutput: "FAILED",
      to: "visual-decision",
    },
    {
      id: "verification-error-to-visual-decision",
      from: "run-verification",
      fromOutput: "ERROR",
      to: "visual-decision",
    },
    ...
    {
      id: "visual-success-to-validate",
      from: "visual-review",
      fromOutput: "SUCCESS",
      to: "validate-goal",
    },
    {
      id: "visual-unavailable-to-validate",
      from: "visual-review",
      fromOutput: "UNAVAILABLE",
      to: "validate-goal",
    },
    {
      id: "visual-error-to-validate",
      from: "visual-review",
      fromOutput: "ERROR",
      to: "validate-goal",
    },
    {
      id: "validation-done-to-mark-completed",
      from: "validate-goal",
      fromOutput: "DONE",
    ...
    {
      id: "mark-repairing-to-select",
      from: "mark-tasks-repairing",
      fromOutput: "SUCCESS",
      to: "assess-goal-tasks",
    },
    {
      id: "mark-repairing-missing",
      from: "mark-tasks-repairing",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-repairing-invalid",
      from: "mark-tasks-repairing",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-repairing-error",
      from: "mark-tasks-repairing",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-completed-to-select",
      from: "mark-tasks-completed",
      fromOutput: "SUCCESS",
      to: "assess-goal-tasks",
    },
    {
      id: "mark-completed-missing-to-select",
      from: "mark-tasks-completed",
      fromOutput: "NOT_FOUND",
      to: "assess-goal-tasks",
    },
    {
      id: "mark-completed-invalid",
      from: "mark-tasks-completed",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-completed-error",
      from: "mark-tasks-completed",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    ...
    {
      id: "mark-deferred-invalid",
      from: "mark-tasks-deferred",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "mark-deferred-error",
      from: "mark-tasks-deferred",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "read-completed-to-append",
      from: "read-completed-goal",
      fromOutput: "SUCCESS",
      to: "append-completed-goal",
    },
    {
      id: "read-completed-invalid",
      from: "read-completed-goal",
      fromOutput: "INVALID",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "read-completed-not-found",
      from: "read-completed-goal",
      fromOutput: "NOT_FOUND",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "read-completed-error",
      from: "read-completed-goal",
      fromOutput: "ERROR",
      to: "record-invalid-goal-outcome",
    },
    {
      id: "append-completed-to-outcome",
      from: "append-completed-goal",
      fromOutput: "SUCCESS",
      to: "record-done-goal-outcome",
    },
    {
    ...
    {
      id: "done-outcome-to-archive",
      from: "record-done-goal-outcome",
      fromOutput: "SUCCESS",
      to: "archive-goal",
    },
    {
      id: "done-outcome-invalid-to-retained-report",
      from: "record-done-goal-outcome",
      fromOutput: "INVALID",
      to: "retained-goal-report",
    },
    {
      id: "done-outcome-error-to-retained-report",
      from: "record-done-goal-outcome",
      fromOutput: "ERROR",
      to: "retained-goal-report",
    },
    ...
    {
      id: "deferred-outcome-error-to-retained-report",
      from: "record-deferred-goal-outcome",
      fromOutput: "ERROR",
      to: "retained-goal-report",
    },
    ...
    {
      id: "no-action-outcome-to-stop-report",
      from: "record-no-action-goal-outcome",
      fromOutput: "SUCCESS",
      to: "stop-goal-report",
    },
    {
      id: "no-action-outcome-invalid-to-retained-report",
      from: "record-no-action-goal-outcome",
      fromOutput: "INVALID",
      to: "retained-goal-report",
    },
    {
      id: "no-action-outcome-error-to-retained-report",
      from: "record-no-action-goal-outcome",
      fromOutput: "ERROR",
      to: "retained-goal-report",
    },
    {
      id: "invalid-outcome-to-retained-report",
      from: "record-invalid-goal-outcome",
      fromOutput: "SUCCESS",
      to: "retained-goal-report",
    },
    {
      id: "invalid-outcome-invalid-to-retained-report",
      from: "record-invalid-goal-outcome",
      fromOutput: "INVALID",
      to: "retained-goal-report",
    },
    {
      id: "invalid-outcome-error-to-retained-report",
      from: "record-invalid-goal-outcome",
      fromOutput: "ERROR",
      to: "retained-goal-report",
    },
    ...
    {
      id: "archive-not-found-to-report",
      from: "archive-goal",
      fromOutput: "NOT_FOUND",
      to: "final-report",
    },
