...
const autonomousRefactoringFlow: RalphFlow = {
  ...
  variables: [
    ...
    {
      name: "refactorObjective",
      type: "text",
      default: "Improve maintainability while preserving behavior.",
      required: false,
    },
    {
      name: "fileNamingPolicy",
      type: "text",
      default: "Follow existing framework and repository conventions.",
      required: false,
    },
    { name: "maxFileLines", type: "number", default: "500", required: false },
    {
      name: "helperPlacementPolicy",
      type: "text",
      default: "Follow existing module-local and shared helper conventions.",
      required: false,
    },
    {
      name: "testFramework",
    ...
    { name: "validationCommand", type: "text", default: "", required: false },
    {
      ...
      type: "text",
      default:
        "node_modules, dist, build, coverage, target, .next, .nuxt, .turbo, .cache, vendor, generated",
      required: false,
    },
    {
    ...
    },
    {
      ...
      type: "path",
      default: "{{run:artifactRoot}}/refactor/project-commands.json",
      required: false,
    },
    {
      name: "refactorPlanFile",
      type: "path",
      default: "{{run:artifactRoot}}/refactor/refactor-plan.json",
      required: false,
    },
    {
      name: "gitSnapshotFile",
      type: "path",
      default: "{{run:artifactRoot}}/refactor/git-snapshot.json",
      required: false,
    },
    {
      name: "gitDiffFile",
      type: "path",
      default: "{{run:artifactRoot}}/refactor/git-diff.json",
      required: false,
    },
    {
      name: "refactorReportFile",
      type: "path",
      default: "{{run:artifactRoot}}/refactor/final-report.json",
      required: false,
    },
    {
      name: "refactorReportMarkdown",
      type: "path",
      default: "{{run:artifactRoot}}/refactor/final-report.md",
      required: false,
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      utility: {
        ...
        excludePaths:
          "{{excludePaths:text=node_modules, dist, build, coverage, target, .next, .nuxt, .turbo, .cache, vendor, generated}}",
  ...
  edges: [
    ...
    {
      id: "count-refactor-pass-continue",
      from: "count-refactor-pass",
      fromOutput: "CONTINUE",
      to: "refactor-pass",
    },
    {
      id: "count-refactor-pass-limit",
      from: "count-refactor-pass",
      fromOutput: "LIMIT_REACHED",
      to: "defer-scope",
    },
    {
      id: "count-refactor-pass-error",
      from: "count-refactor-pass",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    {
      id: "refactor-to-validation-tier",
      from: "refactor-pass",
      fromOutput: "SUCCESS",
    ...
    {
      id: "validation-tier-to-decision",
      from: "select-validation-command",
      fromOutput: "SUCCESS",
      to: "validation-decision",
    },
    {
      id: "validation-tier-error",
      from: "select-validation-command",
      fromOutput: "ERROR",
      to: "validation-decision",
    },
    {
      id: "validation-decision-run",
      from: "validation-decision",
      fromOutput: "MATCH",
      to: "run-validation-checks",
    },
    {
      id: "validation-decision-skip",
      from: "validation-decision",
      fromOutput: "NO_MATCH",
      to: "git-diff-summary",
    },
    {
      id: "validation-decision-error",
      from: "validation-decision",
      fromOutput: "ERROR",
      to: "git-diff-summary",
    },
    {
      id: "validation-success-to-diff",
      from: "run-validation-checks",
      fromOutput: "SUCCESS",
      to: "git-diff-summary",
    },
    {
      id: "validation-failed-to-repair-counter",
      from: "run-validation-checks",
      fromOutput: "FAILED",
      to: "count-verification-repair",
    },
    {
      id: "validation-error-to-repair-counter",
      from: "run-validation-checks",
      fromOutput: "ERROR",
      to: "count-verification-repair",
    },
    ...
    {
      id: "progress-analysis-to-decision",
      from: "refactor-progress-analysis",
      fromOutput: "SUCCESS",
      to: "refactor-progress-produced",
    },
    {
      id: "progress-analysis-error",
      from: "refactor-progress-analysis",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    {
      id: "progress-produced-to-scan-counter",
      from: "refactor-progress-produced",
      fromOutput: "MATCH",
      to: "count-final-refactor-scan",
    },
    {
      id: "progress-stalled-to-defer",
      from: "refactor-progress-produced",
      fromOutput: "NO_MATCH",
      to: "defer-scope",
    },
    {
      id: "progress-decision-error",
      from: "refactor-progress-produced",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
      ...
      routeOverrides: [
        {
          ...
          toBlockId: "select-validation-command",
        },
        {
        ...
        {
          edgeId: "refactor-to-validation-tier",
          toBlockId: "validation-decision",
        },
        {
          edgeId: "validation-tier-to-decision",
          toBlockId: "baseline-validation",
        },
        {
          edgeId: "validation-tier-error",
          toBlockId: "baseline-validation",
        },
      ],
    },
