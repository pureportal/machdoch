...
const autonomousUiImprovementLoopFlow: RalphFlow = {
  ...
  variables: [
    ...
    },
    {
      name: "designPolicy",
      type: "text",
      default: ENRICHED_UI_DESIGN_POLICY,
      required: false,
    },
    {
      name: "uiImprovementPolicy",
      type: "text",
      default:
        "Prefer visible, user-facing UI improvements that make the product clearer, calmer, more responsive, more accessible, and easier to operate. Preserve coherent product conventions, but allow a complete view-level redesign or component refactor when comparative repository evidence shows the current surface is materially behind sibling views.",
      required: false,
    },
    {
      ...
      type: "text",
      default:
        "Continue only when there is concrete UI evidence: layout overflow, overlapping text, responsive breakage, accessibility issue, confusing hierarchy, overexplained copy, badge/icon misuse, inconsistent design-system usage, hydration/console errors, or a clearly bounded visual opportunity with user value. Stop instead of inventing speculative redesigns or tiny cosmetic nits, but do not treat a small diff as success when the selected package or sibling-view comparison supports a larger coherent refactor.",
      required: false,
    },
    {
      name: "riskTolerance",
    ...
    },
    {
      ...
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/project-commands.json",
      required: false,
    },
    {
      name: "candidateFile",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/candidate.json",
      required: false,
    },
    {
      name: "reviewFile",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/review.json",
      required: false,
    },
    {
      name: "gitSnapshotFile",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/git-snapshot.json",
      required: false,
    },
    {
      name: "gitDiffFile",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/git-diff.json",
      required: false,
    },
    {
      name: "uiReportFile",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/final-report.json",
      required: false,
    },
    {
      name: "uiReportMarkdown",
      type: "path",
      default: "{{run:artifactRoot}}/ui-improvements/final-report.md",
      required: false,
    },
    {
      name: "notesFile",
  ...
  edges: [
    ...
    {
      id: "detect-empty-to-history",
      from: "detect-project-commands",
      fromOutput: "EMPTY",
      to: "read-completed-ui-improvements",
    },
    {
      id: "detect-error-to-history",
      from: "detect-project-commands",
      fromOutput: "ERROR",
      to: "read-completed-ui-improvements",
    },
    ...
    {
      id: "propose-to-research-decision",
      from: "propose-ui-improvements",
      fromOutput: "SUCCESS",
    ...
    {
      id: "research-to-refine",
      from: "ui-research",
      fromOutput: "SUCCESS",
      to: "choose-ui-improvement",
    },
    {
      id: "research-error-to-refine",
      from: "ui-research",
      fromOutput: "ERROR",
      to: "choose-ui-improvement",
    },
    {
      id: "choose-to-actionable",
      from: "choose-ui-improvement",
      fromOutput: "SUCCESS",
      to: "has-actionable-ui-improvement",
    },
    {
      id: "choose-invalid",
      from: "choose-ui-improvement",
    ...
    {
      id: "actionable-to-find-active",
      from: "has-actionable-ui-improvement",
      fromOutput: "MATCH",
      to: "find-active-ui-improvement",
    },
    {
      id: "not-actionable-to-classify",
      from: "has-actionable-ui-improvement",
      fromOutput: "NO_MATCH",
    ...
    {
      id: "selection-deferred",
      from: "selection-is-deferred",
      fromOutput: "MATCH",
      to: "defer-scope",
    },
    {
      id: "selection-stopped",
      from: "selection-is-deferred",
      fromOutput: "NO_MATCH",
      to: "mark-stop-scope",
    },
    {
      id: "selection-classification-error",
      from: "selection-is-deferred",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    {
      id: "active-ui-exists",
      from: "find-active-ui-improvement",
      fromOutput: "EXISTS",
      to: "archive-superseded-ui-improvement",
    },
    {
      id: "active-ui-missing",
      from: "find-active-ui-improvement",
      fromOutput: "MISSING",
      to: "write-active-ui-improvement",
    },
    {
      id: "active-ui-check-error",
      from: "find-active-ui-improvement",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    {
      id: "superseded-ui-archive-to-write",
      from: "archive-superseded-ui-improvement",
      fromOutput: "SUCCESS",
      to: "write-active-ui-improvement",
    },
    {
      id: "superseded-ui-archive-missing-to-write",
      from: "archive-superseded-ui-improvement",
      fromOutput: "NOT_FOUND",
      to: "write-active-ui-improvement",
    },
    {
      id: "superseded-ui-archive-error",
      from: "archive-superseded-ui-improvement",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    {
      id: "write-to-snapshot",
      from: "write-active-ui-improvement",
      fromOutput: "SUCCESS",
    ...
    {
      id: "snapshot-error-to-baseline",
      from: "git-snapshot-before",
      fromOutput: "ERROR",
      to: "baseline-verification",
    },
    {
      id: "baseline-success-to-count",
      from: "baseline-verification",
      fromOutput: "SUCCESS",
      to: "count-ui-improvement-pass",
    },
    {
      id: "baseline-failed-to-count",
      from: "baseline-verification",
      fromOutput: "FAILED",
      to: "count-ui-improvement-pass",
    },
    {
      id: "baseline-error-to-count",
      from: "baseline-verification",
      fromOutput: "ERROR",
      to: "count-ui-improvement-pass",
    },
    {
      id: "count-ui-improvement-pass-continue",
      from: "count-ui-improvement-pass",
      fromOutput: "CONTINUE",
      to: "implement-ui-improvement",
    },
    {
      id: "count-ui-improvement-pass-limit",
      from: "count-ui-improvement-pass",
      fromOutput: "LIMIT_REACHED",
      to: "defer-scope",
    },
    {
      id: "count-ui-improvement-pass-error",
      from: "count-ui-improvement-pass",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    {
      id: "implement-to-verification-tier",
    ...
    {
      id: "verification-tier-to-decision",
      from: "select-verification-command",
      fromOutput: "SUCCESS",
      to: "verification-decision",
    },
    {
      id: "verification-tier-error",
      from: "select-verification-command",
      fromOutput: "ERROR",
      to: "verification-decision",
    },
    ...
    {
      id: "verification-success-to-runtime-urls",
      from: "run-verification",
      fromOutput: "SUCCESS",
      to: "resolve-runtime-urls",
    },
    {
      id: "verification-failed-to-repair-counter",
      from: "run-verification",
      fromOutput: "FAILED",
      to: "count-verification-repair",
    },
    {
      id: "verification-error-to-repair-counter",
      from: "run-verification",
      fromOutput: "ERROR",
      to: "count-verification-repair",
    },
    {
      id: "repair-counter-to-fix",
      from: "count-verification-repair",
      fromOutput: "CONTINUE",
      to: "fix-validation-failures",
    },
    {
      id: "repair-counter-limit",
      from: "count-verification-repair",
      fromOutput: "LIMIT_REACHED",
      to: "defer-scope",
    },
    {
      id: "repair-counter-error",
      from: "count-verification-repair",
      fromOutput: "ERROR",
      to: "defer-scope",
    },
    {
      id: "fix-validation-to-decision",
      from: "fix-validation-failures",
      fromOutput: "SUCCESS",
      to: "verification-decision",
    },
    {
    ...
    {
      id: "runtime-urls-success-to-visual-decision",
      from: "resolve-runtime-urls",
      fromOutput: "SUCCESS",
      to: "visual-decision",
    },
    {
      id: "runtime-urls-error-to-visual-decision",
      from: "resolve-runtime-urls",
      fromOutput: "ERROR",
      to: "visual-decision",
    },
    {
      id: "visual-decision-run",
      from: "visual-decision",
      fromOutput: "MATCH",
      to: "visual-review",
    },
    {
      id: "visual-decision-skip",
      from: "visual-decision",
      fromOutput: "NO_MATCH",
      to: "git-diff-summary",
    },
    {
      id: "visual-decision-error",
      from: "visual-decision",
      fromOutput: "ERROR",
      to: "git-diff-summary",
    },
    {
      id: "visual-success-to-diff",
      from: "visual-review",
      fromOutput: "SUCCESS",
      to: "git-diff-summary",
    },
    {
      id: "visual-unavailable-to-diff",
      from: "visual-review",
      fromOutput: "UNAVAILABLE",
      to: "git-diff-summary",
    },
    {
      id: "visual-error-to-diff",
      from: "visual-review",
      fromOutput: "ERROR",
      to: "git-diff-summary",
    },
    {
      id: "diff-success-to-scope-guard",
      from: "git-diff-summary",
      fromOutput: "SUCCESS",
      to: "scope-change-guard",
    },
    {
      id: "diff-empty-to-scope-guard",
      from: "git-diff-summary",
      fromOutput: "EMPTY",
      to: "scope-change-guard",
    },
    {
      id: "diff-error-to-scope-guard",
      from: "git-diff-summary",
      fromOutput: "ERROR",
      to: "scope-change-guard",
    },
    ...
    {
      id: "work-yield-to-decision",
      from: "work-yield-analysis",
      fromOutput: "SUCCESS",
      to: "useful-work-produced",
    },
    {
      id: "work-yield-error-to-count",
      from: "work-yield-analysis",
      fromOutput: "ERROR",
      to: "count-ui-improvement-pass",
    },
    {
      id: "useful-work-to-review",
      from: "useful-work-produced",
      fromOutput: "MATCH",
      to: "review-tier-decision",
    },
    {
      id: "no-useful-work-to-count",
      from: "useful-work-produced",
      fromOutput: "NO_MATCH",
      to: "count-ui-improvement-pass",
    },
    {
      id: "useful-work-error-to-count",
      from: "useful-work-produced",
      fromOutput: "ERROR",
      to: "count-ui-improvement-pass",
    },
    {
      id: "review-tier-strict",
      from: "review-tier-decision",
      fromOutput: "MATCH",
      to: "independent-ui-review",
    },
    {
      id: "review-tier-validator-only",
      from: "review-tier-decision",
      fromOutput: "NO_MATCH",
      to: "validate-ui-improvement",
    },
    {
      id: "review-tier-error-to-validate",
      from: "review-tier-decision",
      fromOutput: "ERROR",
      to: "validate-ui-improvement",
    },
    {
      id: "review-to-defer-check",
      from: "independent-ui-review",
      fromOutput: "SUCCESS",
      to: "review-is-deferred",
    },
    {
      id: "review-invalid",
      from: "independent-ui-review",
    ...
    {
      id: "review-deferred",
      from: "review-is-deferred",
      fromOutput: "MATCH",
      to: "defer-scope",
    },
    {
      id: "review-not-deferred",
      from: "review-is-deferred",
      fromOutput: "NO_MATCH",
      to: "review-needs-fix",
    },
    {
      id: "review-defer-check-error",
      from: "review-is-deferred",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    ...
    {
      id: "read-active-success-to-append",
      from: "read-active-ui-improvement",
      fromOutput: "SUCCESS",
      to: "append-completed-ui-improvement",
    },
    {
      id: "read-active-invalid",
      from: "read-active-ui-improvement",
      fromOutput: "INVALID",
      to: "mark-invalid-scope",
    },
    {
      id: "read-active-not-found",
      from: "read-active-ui-improvement",
      fromOutput: "NOT_FOUND",
      to: "mark-invalid-scope",
    },
    {
      id: "read-active-error",
      from: "read-active-ui-improvement",
      fromOutput: "ERROR",
      to: "mark-invalid-scope",
    },
    ...
    {
      id: "mark-stop-to-ledger",
      from: "mark-stop-scope",
      fromOutput: "SUCCESS",
      to: "record-stop-outcome",
    },
    {
      id: "mark-stop-missing-to-ledger",
      from: "mark-stop-scope",
      fromOutput: "NOT_FOUND",
      to: "record-stop-outcome",
    },
    {
      id: "mark-stop-error-to-ledger",
      from: "mark-stop-scope",
      fromOutput: "ERROR",
      to: "record-stop-outcome",
    },
    ...
    {
      id: "archive-to-report",
      from: "archive-active-ui-improvement",
      fromOutput: "SUCCESS",
      to: "final-report",
    },
    {
      id: "archive-missing-to-report",
      from: "archive-active-ui-improvement",
      fromOutput: "NOT_FOUND",
      to: "final-report",
    },
    {
      id: "archive-error-to-retained-report",
      from: "archive-active-ui-improvement",
      fromOutput: "ERROR",
      to: "retained-active-report",
    },
      ...
      routeOverrides: [
        {
          ...
          toBlockId: "select-verification-command",
        },
        {
          edgeId: "snapshot-error-to-baseline",
          toBlockId: "select-verification-command",
        },
        {
          edgeId: "implement-to-verification-tier",
          toBlockId: "verification-decision",
        },
        {
          edgeId: "verification-tier-to-decision",
          toBlockId: "baseline-verification",
        },
        {
          edgeId: "verification-tier-error",
          toBlockId: "baseline-verification",
        },
      ],
    },
