...
export const VALID_MODEL_PROVIDERS = [
  "openai",
  "anthropic",
  "google",
  "langdock",
...
export const USER_API_PROVIDERS = [
  "openai",
  "anthropic",
  "google",
  "langdock",
...
export const USER_WEB_SEARCH_PROVIDERS = [
  "perplexity",
  "tavily",
  "serper",
] as const;
...
export const RUNTIME_MEMORY_SCOPES = [
  "session",
  "workspace",
  "global",
] as const;
...
export const RUNTIME_MEMORY_KINDS = [
  "preference",
  "constraint",
  "decision",
  "fact",
...
export const DEFAULT_MODEL_PROVIDER =
  "openai" as const satisfies ConfiguredModelProvider;
...
export const DEFAULT_USER_INTERNAL_TASK_MODEL_SETTINGS = {
  reasoning: "default",
} as const satisfies UserInternalTaskModelSettings;
...
export const isReasoningMode = (
  value: string | undefined,
): value is ReasoningMode => isRuntimeContractValue(REASONING_MODES, value);
...
export const isContextWindow = (value: unknown): value is ContextWindow =>
  (typeof value === "string" &&
    isRuntimeContractValue(CONTEXT_WINDOW_MODES, value)) ||
  (typeof value === "number" &&
...
export const isModelProvider = (
  value: string | undefined,
): value is ModelProvider => isRuntimeContractValue(MODEL_PROVIDERS, value);

export const isUserApiProvider = (
  value: string | undefined,
): value is UserApiProvider =>
  isRuntimeContractValue(USER_API_PROVIDERS, value);

export const isAgentCliProvider = (
  value: string | undefined,
): value is AgentCliProvider =>
...
export const isAudioProvider = (
  value: string | undefined,
): value is AudioProvider =>
...
export interface RuntimeSnapshot extends Omit<
  RuntimeConfig,
  "agentLimits" | "contextWindow" | "internalTaskModel"
> {
  defaultMode: RunMode;
...
export type UserWebSearchApiKeys = Partial<
  Record<UserWebSearchProvider, string>
>;
